...
<body>
  <div class="container">
    ...
    <div class="photo-carousel">
      <a href="halaman1.html" target="_self" class="photo-item" onclick="checkStorageAndDownload(44)">
        <img src="img/IMG_8331.png" alt="Image 1">
        <div class="photo-item">1</div>
      </a>
      <a href="halaman2.html" target="_self" class="photo-item" onclick="checkStorageAndDownload(44)">
        <img src="img/IMG_8331.png" alt="Image 2">
        <div class="photo-item">2</div>
      </a>
      <a href="halaman3.html" target="_self" class="photo-item" onclick="checkStorageAndDownload(44)">
        <img src="img/IMG_8331.png" alt="Image 3">
        <div class="photo-item">3</div>
      </a>
      <a href="halaman4.html" target="_self" class="photo-item" onclick="checkStorageAndDownload(44)">
    ...
    <div class="image-gallery">
      <div class="gallery-item" onclick="checkStorageAndDownload(44)">
      ...
      <div class="gallery-item" onclick="checkStorageAndDownload(44)">
        <img src="img/IMG_8331.png" alt="CANADA">
        <div>CANADA</div>
      </div>
      <div class="gallery-item" onclick="checkStorageAndDownload(44)">
        <img src="img/IMG_8331.png" alt="PHILIPINA">
        <div>PHILIPINA</div>
      </div>
    </div>
  </div>
